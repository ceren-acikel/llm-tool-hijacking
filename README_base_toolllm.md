# Original ToolLLM README Snapshot

This file is preserved as a reference snapshot of the original ToolLLM documentation.

The main repository documentation for this thesis implementation is provided in `README.md`.

This project builds on ToolLLM but contains substantial modifications for a controlled security evaluation setting.
